        ...
        <div class="row">
            <div class="col-md-8 h" style="margin-top: 0">
                <h2 style="margin-bottom: 1.2em;" class="line-full-width">
                    <span class="span-line">Announcement</span>
                </h2>
                <div class="row">
                ...
                <a class="btn btn--unhi btn--icon" href="{{ route('id.list_pengumuman')}}" style="margin-top: 10px;">
                    <span class="btn__text"><i class=""></i>See More Announcement</span>
                </a>
            </div>
            <div class="col-md-4 agenda-sidebar">
                ...
                <a class="btn btn--unhi btn--icon" href="{{ route('id.list_agenda')}}">
                    <span class="btn__text"><i class=""></i>See More Agenda</span>
                </a>
                ...
                <div class="container">
                    <div class="cta cta--horizontal text-center-xs row">
                        <div class="pojok-unhi">
                            <a href="{{route('id.ayurweda_list')}}" class="a-black">
                    ...
                    <div class="cta cta--horizontal text-center-xs row">
                        <div class="pojok-unhi">
                            <a href="{{route('id.list_warta_unhi')}}" class="a-black">
                                <h2 class=" text"><span class="text-yellow-black">Warta</span><span class="text-blue-white" style="background: #002d69; text-transform: uppercase;">Unhi</span></h2>
                            </a>
                        </div>
                    </div>
                </div>
...
<section  class="bg--secondary section-style">
    <div class="container">
        <h2 style="margin-bottom: 1.2em;" class="line-full-width">
                <span class="span-line">News UNHI</span>
            </h2>
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a class="btn btn--unhi btn--icon" href="{{route('id.list_berita')}}">
                            <span class="btn__text"><i class=""></i>See More News</span>
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <a class="btn btn--unhi btn--icon" style="margin-bottom:20px" href="{{route('id.detail_agama_budaya', $agama_budaya->slug)}}">
                    <span class="btn__text"><i class=""></i>Read Full Article</span>
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <div>
...
<section class="bg--secondary section-style" >
    <div class="container">
        <h2 style="margin-bottom: 1.2em;" class="line-full-width">
                    <span class="span-line">VIDEOS & PHOTOS GALLERY</span>
                </h2>
        <div class="row">
            <div class="col-md-6 col-12">
                ...
                <a class="btn btn--unhi btn--icon" href="{{ route('id.list_video',$video->slug)}}" style="margin-top: 10px; margin-bottom:20px">
                    <span class="btn__text"><i class=""></i>More Videos</span>
                </a>
            </div>
            <div class="col-md-6">
                ...
                <a class="btn btn--unhi btn--icon" href="{{ route('id.list_gallery_latest', [$detailgallery1->gallery->slug])}}" style="margin-top: 10px;">
                    <span class="btn__text"><i class=""></i>More Photos Gallery</span>
                </a>
            </div>
        </div>
        <!--end of row-->
