        ...
        <div class="row">
            ...
            <div class="masonry">
                <h2 style="margin-bottom: 1.2em;" class="line-full-width">
                    <span class="span-line"> Berita Utama</span>
                </h2>
                ...
                <h3 style="margin-bottom: 1.1em;" class="line-full-width">
                    <span class="span-line"> Berita Terbaru</span>
                </h3>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <article class="feature feature-1">
                            <a href="{{ route('id.detail_berita', $berita->slug)}}" class="block">
                                <img class="bg-holder-list-info" alt="Image" src="{{ URL::asset($berita->thumbnail_url) }}" />
                            </a>
