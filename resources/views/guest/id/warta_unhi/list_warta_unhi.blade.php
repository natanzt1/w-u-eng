                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="feature feature-1 boxed boxed--border" style="min-height:auto;">
                            @foreach($warta_unhis as $i=>$warta)
                            <div class="row">
                                <div class="col-md-1 d-none d-sm-block">
                                    <h4 style="padding-top: 15px;">{{$i+1}}</h4>
                                </div>
                                <div class="col-md-7 col-12 text-center">                                
                                    <h4>{{$warta->nama_warta}}</h4>
                                    <span class="type--fade"><i class="fa fa-clock-o"></i>{{$warta->updated_at->format('l, d F Y')}}</span>
                                </div>
                                <div class="col-md-2 col-6 text-center">
                                    <span class="h6 type--uppercase m-b-0">Lihat</span>
                                    <a href="{{ route('id.see_warta_unhi',[$warta->slug]) }}" target="_blank">
                                        <i class="material-icons">find_in_page</i>
                                    </a>
                                </div>
                                <div class="col-md-2 col-6 text-center">
                                    <span class="h6 type--uppercase m-b-0">Unduh</span>
                                    <a href="{{ asset($warta->url) }}">
