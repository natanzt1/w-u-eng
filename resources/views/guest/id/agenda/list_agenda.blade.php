                    ...
                    <div class="col-md-6">
                        <article class="feature feature-1">
                            <a href="{{ route('id.detail_agenda', $agenda->slug)}}" class="block">
                                <span class="label agenda-list-label type--bold">{{$agenda->waktu_mulai->format('d F')}}</span>
                                @if( !empty($agenda->thumbnail_url))
                                    <img class="bg-holder-list-info" alt="Image" src="{{ URL::asset($agenda->thumbnail_url) }}" />
                                @else
                                    <img class="bg-holder-list-info" alt="Image" src="{{ URL::asset('guest/img/lib/bendera-unhi.png') }}" />
                                @endif                                
                            </a>
