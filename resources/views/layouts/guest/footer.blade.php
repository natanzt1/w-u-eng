    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 col-12 m-t-20">
                ...
                <ul class="list--hover">
                    <li><a href="http://sruti.unhi.ac.id/" target="_blank">SRUTI UNHI</a></li>
                    <li><a href="http://astamanik.unhi.ac.id/" target="_blank">Astamanik (Akademik)</a></li>
                    <li><a href="http://astabayu.unhi.ac.id/" target="_blank">Astabayu (e-Payment)</a></li>
                    <li><a href="http://smrti.unhi.ac.id/" target="_blank">SMRTI (e-Registrasi)</a></li>
                    <li><a href="http://aswin.unhi.ac.id/" target="_blank">ASWIN (Wisuda)</a></li>
                    <li><a href="http://astakali.unhi.ac.id/" target="_blank">ASTAKALI (e-Perpus)</a></li>
                </ul>
            </div>
            <div class="col-md-6 col-lg-3 col-12 m-t-20">
