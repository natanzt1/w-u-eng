    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-12 col-md-offset-2">
				<form action="{{route('admin.portal.update', [$data->slug])}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Nama portal</label>
					    <input type="text" class="form-control" name="nama_portal" id="nama" value="{{$data->nama_portal}}" required>
					    @if(count($errors)>0)
					...
					<div class="form-group">
					    <label for="Judul">URL portal</label>
					    <input type="text" class="form-control" name="url_portal" id="url" value="{{$data->url}}" required>
					</div>
			</div>
		</div>
		<div class="row">
