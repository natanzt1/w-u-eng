...
<script>
    $(document).on("click", "#delete", function () {
         ...
         var action = "/administrator/fakultas/detail/"+slug+"/delete/"+id; 
    	...
    	<div class="card-body">
	    	<div class="row">
	    		<div class="col-md-10 col-md-offset-2">
	    			<h1>Gallery {{$fakultas->nama_fakultas}}</h1>
	    		</div>
	    		<div class="col-md-2 col-md-offset-2">
	    			<button 
	    				type="button" class="btn btn-primary" id="new_gallery" data-toggle="modal" data-target="#tambah_foto" data-slug="{{$fakultas->slug}}">
						Tambah Foto
					</button>
	    		</div>
	    	</div>
					...
					<table id="gallery" class="table table-striped table-bordered" style="width:100%">
				        ...
				        <tbody>
				            ...
				            <tr>
				                ...
				                <td>
				                	<button type="button" class="btn btn-danger" id="delete" data-id="{{$data->id}}" data-slug="{{$slug}}" data-toggle="modal" data-target="#deleteModal">
									  Hapus
									</button>
				                </td>
				            </tr>
...
<div class="modal fade" id="tambah_foto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-modal" action="{{route('admin.fakultas.storedetail',[$slug])}}" width="200px" method="post" enctype="multipart/form-data">
            @csrf
