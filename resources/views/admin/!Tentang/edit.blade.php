    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="{{route('admin.tentang.update', [$data[0]->slug])}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Nama Profil</label>
					    <input type="text" class="form-control" name="nama_tentang" value="{{$data[0]->nama_tentang}}" required>
					</div>

					<div class="form-group">
					    <label for="Judul">Isi Profil</label>
					    <textarea class="form-control" name="konten_tentang" style="height: 300px">{!! $data[0]->konten !!}</textarea>
					</div>
			</div>
			...
			<div class="col-md-4 col-md-offset-2">
				<span class="border-bottom">
					...
					<br>
					<div class="form-group">
						<label for="Thumbnail tentang">Upload Thumbnail Baru</label>
