    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="{{route('admin.tentang.update', [$slug, $data[0]->id])}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Judul tentang</label>
					    <input type="text" class="form-control" name="nama_tentang" value="{{$data[0]->nama}}" required>
					</div>

					<div class="form-group">
					    <label for="Judul">Deskripsi</label>
					    <textarea class="form-control" name="deskripsi" style="height: 300px">{!! $data[0]->deskripsi !!}</textarea>
					</div>
			</div>
			...
			<div class="col-md-4 col-md-offset-2">
				<span class="border-bottom">
					<div class="form-group">
					    <label for="Thumbnail tentang">Thumbnail tentang</label>
					    <img src="{{URL::asset($data[0]->thumbnail_url)}}" width="350">
					</div>
					<br>
					<div class="form-group">
						<label for="Thumbnail tentang">Upload Thumbnail tentang Baru</label>
