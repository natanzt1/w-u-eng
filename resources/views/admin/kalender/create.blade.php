...
<div class="section-block center-holder">
    <div class="container">
    	<h1>Buat Artikel kalender Baru</h1>
		<hr>
		<div class="row">
				  	...
				  	<div class="form-group">
					    ...
					    @if(count($errors)>0)
					    	@foreach($errors->all() as $error)
					    		<small class="alert-danger">*Tahun Ajaran sudah dipakai atau file kalender belum diupload*</small>
					    	@endforeach
					    @endif
					</div>
			</div>
			...
			<div class="col-md-4 col-md-offset-2">
				<span class="border-bottom">
					<div class="form-group">
					    <label for="Thumbnail kalender">Dokumen Kalender</label>
