				...
				<form action="{{route('admin.agenda.store')}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    ...
					    <input type="text" class="form-control" id="nama" name="nama_agenda" required>
					    @if(count($errors)>0)
					...
					<div class="row">
	                    <div class="col-lg-6">
	                        ...
	                        <div class="row">
	                            <div class="col-lg-7 ">
	                            	<input type="text" name="tgl_mulai" id="date_start" class=" date-pick form-control" required>
	                            </div>
	                            <div class="col-lg-5 "><input type="time" name="waktu_mulai" id="time_start" value="01:59" class="form-control" required></div>
	                        </div>
	                    </div>
	                    <div class="col-lg-6">
	                        <label for="event_ends">Berakhir</label>
	                        <div class="row">
	                            <div class="col-lg-7 "><input type="text" name="tgl_selesai" id="date_end" class=" date-pick form-control" required></div>
	                            <div class="col-lg-5 "><input type="time" name="waktu_selesai" id="time_end" value="23:59"class="form-control" required></div>
	                        </div>
	                    </div>
	                </div>
	                <br>
					<div class="form-group">
					    ...
					    <textarea class="form-control" name="konten_agenda" id="deskripsi" style="height: 300px;"></textarea>
					</div>
			</div>
