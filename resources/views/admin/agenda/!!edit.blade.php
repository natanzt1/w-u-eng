    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="{{route('admin.agenda.update', [$data[0]->slug])}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Judul Agenda</label>
					    <input type="text" class="form-control" name="nama_agenda" value="{{$data[0]->nama_agenda}}" required>
					</div>

					<div class="form-group">
					    <label for="Judul">Deskripsi Agenda</label>
					    <textarea class="form-control" name="konten_agenda" style="height: 300px">{!! $data[0]->konten !!}</textarea>
					</div>
			</div>
			...
			<div class="col-md-4 col-md-offset-2">
				<span class="border-bottom">
					...
					<br>
					<div class="form-group">
						<label for="Thumbnail agenda">Upload Thumbnail Baru</label>
