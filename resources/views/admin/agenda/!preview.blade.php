                ...
                <div class="masonry">
                    <article class="single-post">
                        <div class="post-heading">
                            ...
                            <ul class="entry-meta">
                                <li class="post-date">{{$datas[0]->created_at}}</li>
                    ...
                    <div class="blog-comments">
                        <div class="fb-comments" data-href="http://127.0.0.1:8000/id/agenda/detail-agenda/slug" data-width="100%" data-numposts="5"></div>
                    </div>
                </div>
                <!--end masonry-->
            </div>
