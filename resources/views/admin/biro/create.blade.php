				...
				<form action="{{route('admin.biro.store')}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    ...
					    <input type="text" class="form-control" name="nama_biro" id="nama" required>
					    @if(count($errors)>0)
					...
					<div class="form-group">
					    <label for="konten">Deskripsi Biro</label>
					    <textarea class="form-control" name="konten_biro" id="konten" style="height: 300px;"></textarea>
					</div>
			</div>
		</div>
		<div class="row">
