    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="{{route('admin.tentang.update', [$data->slug])}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Judul Konten</label>
					    <input type="text" class="form-control" name="nama_tentang" value="{{$data->nama_tentang}}" required>
					    @if(count($errors)>0)
					...
					<div class="form-group">
					    ...
					    <textarea class="form-control" name="konten_tentang" style="height: 300px">{!! $data->konten !!}</textarea>
					</div>
			</div>
