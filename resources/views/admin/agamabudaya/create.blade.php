...
<div class="section-block center-holder">
    <div class="container">
    	<h1>Buat Artikel Agama-Budaya Baru</h1>
		<hr>
		<div class="row">
				...
				<form action="{{route('admin.agamabudaya.store')}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    ...
					    <input type="text" class="form-control" name="nama_agamabudaya" id="nama" required>
					    @if(count($errors)>0)
					...
					<div class="form-group">
					    ...
					    <textarea class="form-control" name="konten_agamabudaya" id="konten" style="height: 300px;"></textarea>
					</div>
			...
			<div class="col-md-6 col-md-offset-2">
				<span class="border-bottom">
					<div class="form-group">
					    ...
					    <input type="text" class="form-control" name="nama_agamabudaya_en" id="nama_en" required>
					</div>
					...
					<div class="form-group">
					    ...
					    <textarea class="form-control" name="konten_agamabudaya_en" id="konten_en" style="height: 300px;"></textarea>
					</div>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<!-- Modal -->
					<div class="modal fade bd-example-modal-lg" id="create_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
