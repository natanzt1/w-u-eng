    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="{{route('admin.repository.update', [$data->slug])}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Nama repository</label>
					    <input type="text" class="form-control" name="nama_repository" id="nama" value="{{$data->nama_repository}}" required>
					    @if(count($errors)>0)
					...
					<div class="form-group">
					    <label for="Judul">URL repository</label>
					    <input type="text" class="form-control" name="url_repository" id="url" value="{{$data->url}}" required>
					</div>
			</div>
