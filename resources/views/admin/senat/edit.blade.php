    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="{{route('admin.senat.update', [$data->slug])}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Nama Senat</label>
					    <input type="text" class="form-control" name="nama_senat" value="{{$data->nama_senat}}" required>
					    @if(count($errors)>0)
					...
					<div class="form-group">
					    ...
					    <textarea class="form-control" name="konten_senat" style="height: 300px">{!! $data->konten !!}</textarea>
					</div>
			</div>
			...
			<div class="col-md-4 col-md-offset-2">
				<span class="border-bottom">
					<div class="form-group">
					    <label for="logo senat">Logo</label>
					    <img src="{{URL::asset($data->logo_url)}}" width="350">
					</div>
					<br>
					<div class="form-group">
						<label for="logo senat">Upload Logo Baru</label>
