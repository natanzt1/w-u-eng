...
<div class="section-block center-holder">
    <div class="container">
    	<h1>Buat Profil Senat Baru</h1>
		<hr>
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="{{route('admin.senat.store')}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Nama Senat</label>
					    <input type="text" class="form-control" name="nama_senat" required>
					    @if(count($errors)>0)
					...
					<div class="form-group">
					    <label for="konten">Profil Senat</label>
					    <textarea class="form-control" name="konten_senat" style="height: 300px;"></textarea>
					</div>
			</div>
