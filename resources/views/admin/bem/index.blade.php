    	...
    	<div class="card-body">
	    	<div class="row">
	    		...
	    		{{-- <div class="col-md-2 col-md-offset-2">
	    			<a href="{{route('admin.bem.create')}}"><button id="create" class="btn btn-primary">
					...
					<table id="bem" class="table table-striped table-bordered" style="width:100%">
				        ...
				        <tbody>
				            ...
				            <tr>
				                ...
				                @if($data->status == 0)
				                <td><a href="{{route('admin.bem.active', [$data->slug])}}"><button id="active" class="btn btn-danger">Nonaktif</button></a></td>
				                @else
				                ...
				                <td>{{$data->views}}</td>
				                <td>
				                	<a href="{{route('admin.bem.edit', [$data->slug])}}"><button id="edit" class="d-inline btn btn-info"><i class="mdi mdi-pencil"></i></button></a> 
				                	
				                	{{-- <form method="post" action="{{route('admin.bem.delete', [$data->id])}}" class="d-inline">
				                		@csrf
