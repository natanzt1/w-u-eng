...
<div class="section-block center-holder">
    <div class="container">
    	<h1>Buat Artikel Inkubator Bisnis Baru</h1>
		<hr>
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="{{route('admin.inkubator.store')}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Judul Konten</label>
					    <input type="text" class="form-control" name="nama_inkubator" required>
					    @if(count($errors)>0)
					...
					<div class="form-group">
					    ...
					    <textarea class="form-control" name="konten_inkubator" style="height: 300px;"></textarea>
					</div>
			</div>
