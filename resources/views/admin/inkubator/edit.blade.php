    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="{{route('admin.inkubator.update', [$data->slug])}}" method="POST" enctype="multipart/form-data">
					@csrf
				  	<div class="form-group">
					    <label for="Judul">Judul Konten</label>
					    <input type="text" class="form-control" name="nama_inkubator" value="{{$data->nama_inkubator}}" required>
					    @if(count($errors)>0)
					...
					<div class="form-group">
					    ...
					    <textarea class="form-control" name="konten_inkubator" style="height: 300px">{!! $data->konten !!}</textarea>
					</div>
			</div>
			...
			<div class="col-md-4 col-md-offset-2">
				<span class="border-bottom">
					<div class="form-group">
					    <label for="Thumbnail inkubator">Thumbnail</label>
					    <img src="{{URL::asset($data->thumbnail_url)}}" width="350">
					</div>
					<br>
					<div class="form-group">
						<label for="Thumbnail inkubator">Upload Thumbnail Baru</label>
