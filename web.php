...
Route::get('auth', '\App\SSO\AuthRequest@logout')->name('sso');
...
Route::group(['prefix' => 'en'], function () {
    Route::get('/tentang/sejarah', 'Guest\AboutController@aboutSejarahEnglish')->name('en.sejarah');
    Route::get('/tentang/visimisi', 'Guest\AboutController@aboutVisiMisiEnglish')->name('en.visi_misi');
    Route::get('/tentang/makna-lambang', 'Guest\AboutController@aboutMaknaLambangEnglish')->name('en.makna_lambang');
    Route::get('/tentang/rektor-unhi', 'Guest\AboutController@aboutRektorUnhiEnglish')->name('en.rektor_unhi');

    Route::get('/kemahasiswaan/bem', 'Guest\BemController@bem')->name('en.bem');
    Route::get('/kemahasiswaan/bem/visimisi', 'Guest\BemController@bemVisiMisiEnglish')->name('en.bem.visi_misi');
    Route::get('/kemahasiswaan/bem/organisasi', 'Guest\BemController@bemOrganisasiEnglish')->name('en.bem.organisasi');

    Route::get('/kemahasiswaan/senat/ayurweda', 'Guest\SenatController@senatAyurwedaEnglish')->name('en.senat');
    Route::get('/kemahasiswaan/senat/agama-budaya', 'Guest\SenatController@senatBudayaEnglish')->name('en.senat.budaya');
    Route::get('/kemahasiswaan/senat/agama-seni', 'Guest\SenatController@senatSeniEnglish')->name('en.senat.seni');
    Route::get('/kemahasiswaan/senat/ekonomi', 'Guest\SenatController@senatEkonomiEnglish')->name('en.senat.ekonomi');
    Route::get('/kemahasiswaan/senat/mipa', 'Guest\SenatController@senatMipaEnglish')->name('en.senat.mipa');
    Route::get('/kemahasiswaan/senat/teknik', 'Guest\SenatController@senatTeknikEnglish')->name('en.senat.teknik');

    Route::get('/kemahasiswaan/ukm', 'Guest\UkmController@ukmEnglish')->name('en.ukm');

    Route::get('/rilisberita', 'Guest\BeritaController@listBeritaEnglish')->name('en.list_berita');
    Route::get('/berita/detail-berita/{slug}', 'Guest\BeritaController@detailBeritaEnglish')->name('en.detail_berita');

    Route::get('/list-agenda', 'Guest\AgendaController@listAgendaEnglish')->name('en.list_agenda');
    Route::get('/agenda/detail-agenda/{slug}', 'Guest\AgendaController@detailAgendaEnglish')->name('en.detail_agenda');

    Route::get('/list-pengumuman', 'Guest\PengumumanController@listPengumumanEnglish')->name('en.list_pengumuman');
    Route::get('/pengumuman/detail-pengumuman/{slug}', 'Guest\PengumumanController@detailPengumumanEnglish')->name('en.detail_pengumuman');

    Route::get('/list-agama-budaya', 'Guest\BudayaController@listBudayaEnglish')->name('en.list_agama_budaya');
    Route::get('/agama-budaya/detail-agama-budaya/', 'Guest\BudayaController@detailBudayaEnglish')->name('en.detail_agama_budaya');

    Route::get('/video/{slug}', 'Guest\VideoController@listVideoEnglish')->name('en.list_video');
    Route::get('/list-gallery/slug', 'Guest\GaleriController@listGalleryEnglish')->name('en.list_gallery_latest');

    Route::get('/pendidikan/dokumen-akademik/list-kalender-akademik/', 'Guest\DokumenAkademikController@listKalenderEnglish')->name('en.list_kalender');
    Route::get('/pendidikan/dokumen-akademik/list-kalender-akademik/slug', 'Guest\DokumenAkademikController@showKalenderEnglish')->name('en.see_kalender_akademik');

    Route::get('/pendidikan/program', 'Guest\ProgramPendidikanController@programPendidikanEnglish')->name('en.program_pendidikan');

    Route::get('/fakultas/teknik', 'Guest\FakultasController@teknikEnglish')->name('en.fak.teknik');
    Route::get('/fakultas/{slug}', 'Guest\FakultasController@index')->name('en.fak');

    Route::get('/inbis/latar-belakang', 'Guest\InbisController@latarBelakangEnglish')->name('en.inbis.latar_belakang');
    Route::get('/inbis/visi-misi', 'Guest\InbisController@visiMisiEnglish')->name('en.inbis.visi_misi');
    Route::get('/inbis/struktur-organisasi', 'Guest\InbisController@strukturOrganisasiEnglish')->name('en.inbis.organisasi');
    Route::get('/inbis/pendamping-tenant', 'Guest\InbisController@pendampingTenantEnglish')->name('en.inbis.pendamping_tenant');
    Route::get('/inbis/tenant-inwall', 'Guest\InbisController@tenantInwallEnglish')->name('en.inbis.tenant_inwall');
    Route::get('/inbis/tenant-outwall', 'Guest\InbisController@tenantOutwallEnglish')->name('en.inbis.tenant_outwall');

    Route::get('/peta-kampus', 'Guest\MapsController@petaKampusEnglish')->name('en.peta_kampus');

    Route::get('/list-warta-unhi', 'Guest\WartaUnhiController@listWartaUnhiEnglish')->name('en.list_warta_unhi');
    Route::get('/list-warta-unhi/slug', 'Guest\WartaUnhiController@showWartaUnhiEnglish')->name('en.see_warta_unhi');
}); 
Auth::routes();
